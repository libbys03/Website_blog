...
<html>
<head>
        <title>libbys03.github.io/website_blog</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        <h2>Week One</h2>
        <p>
            In the first class, we discussed how the course will run and outlined the course. It was really useful learning about what will be covered in the course. This first class made me feel excited to get cracking into learning about how to create a functioning website, which I have never really dabbled with before. We did some icebreakers like making a name tag which was fun. I really want to delve deep into how to create a functioning website in this course as it will; help to broaden my skills in the future which I want to do.
        </p>
